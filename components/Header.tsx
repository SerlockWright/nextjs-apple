...
import { selectBasketItems } from '../redux/cartSlice';
...
function Header() {
  ...
  return (
    <header className='sticky top-0 z-30 flex w-full items-center justify-between bg-[#e7ecee] p-4'>
        <div className='flex items-center justify-center md:w-1/5'>
            <Link href="/">
                <div className='relative h-10 w-5 cursor-pointer opacity-75 transition hover:opacity-100'>
                    <Image src="https://rb.gy/vsvv2o" layout='fill' objectFit='contain' alt='logo-apple'/>
                </div>
            </Link>
        </div>
        ...
        <div className='gap-x-4 flex items-center justify-center md:w-1/5'>
            ...
            {session ? (
                <Image 
                src={ session.user?.image || "https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp&f=y"} alt=""
