    ...
    return (
        <div>
            ...
            <main className="grid grid-cols-1 lg:grid-cols-9">
                <section className="order-2 mx-auto max-w-xl pb-12 lg:mx-0 lg:col-span-5 lg:max-w-none
                    ...
                    <div className="my-4 ml-4 flex space-x-4 lg:ml-14 xl:ml-14">
                        <div className="flex h-11 w-11 items-center justify-center rounded-full border-2 border-black">
                            <CheckIcon className="h-8 w-8" />
                        </div>
                        <div>
                            <p className="">
                                {/* Taking the last 5 characters of the session_id. */}
                    ...
                    <div className="mx-4 divide-y divide-gray-300 rounded-md border border-gray-300 p-4 lg:ml-14">
                        <div className="space-y-2 pb-3">
                            ...
                            <p className="text-sm text-gray-600">
                                We've accepted your order, and we're getting it ready. Come back to this page for updates
                ...
                {mounted && (
                    <section className="overflow-y-scroll border-y border-l border-gray-300 bg-[#fafafa] lg:order-2
                        lg:col-span-4 lg:h-screen lg:border-y-0">
                        ...
                        {showOrderSummaryCondition && (
                            <div className="mx-auto px-4 py-4 max-w-xl divide-y border-gray-300 lg:mx-0 lg:max-w-lg
                                lg:px-10 lg:py-16">
                                    ...
                                    {products.map((product) => (
                                        <div key={product.id} className="flex items-center space-x-4 text-sm font-medium">
                                            <div className="relative flex h-16 w-16 items-center justify-center rounded-md
                                                ...
                                                <div className="absolute -right-2 -top-2 flex h-5 w-5 bg-[#92af96] items-center
